                              ...
                              <div className='container-fluid'>
                                 <div className='row'>
                                    <div className='col-12 mb-4'>
                                       <img src={item.image} alt={item.name} width="150" className="img-fluid"  />
                                    </div>
                                    <div className='col-12 mb-4'>
                                       <h5><span className='fw-bold'>Current Price:</span> {item.current_price.toLocaleString('en-us')}$</h5>
                                       <h5><span className='fw-bold'>Price change 24h:</span> <span className={item.price_change_24h > 0 ? 'text-success' : 'text-danger' }>{item.price_change_24h.toFixed(2)}$</span></h5>
                                       ...
                                       <h5><span className='fw-bold'>Market Capital Change Percentage 24h:</span> <span className={item.market_cap_change_percentage_24h > 0 ? 'text-success' : 'text-danger'}>{item.market_cap_change_percentage_24h.toFixed(2)}%</span>
                                       </h5>
                                    </div>
                                 </div>
                              </div>
